        ...
        <section className="coor-create-company-card">
          <div className="coor-create-company-head">
            <div>
              ...
              <h1>Crear empresa</h1>
              <p>
                Registra una nueva empresa aliada en la plataforma LivingLab.
              </p>
            </div>

            <button
              type="button"
              className="coor-create-company-back"
              onClick={() => navigate("/coordinador/empresas")}
            >
              Volver a empresas
            </button>
          </div>
          ...
          {message ? (
            <div className="coor-create-company-alert success">{message}</div>
          ) : null}
          {error ? (
            <div className="coor-create-company-alert error">{error}</div>
          ) : null}

          <form
            className="coor-create-company-form"
          ...
          >
            <div className="coor-create-company-form-fields">
              ...
              <SearchableSelect
                ...
                onChange={(value) =>
                  setForm((current) => ({ ...current, representanteId: value }))
                }
